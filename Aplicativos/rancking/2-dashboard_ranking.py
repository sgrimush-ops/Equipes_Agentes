...
RENOMEAR_COLUNAS = [
	...
	"COMPRADOR=COMPRADOR",
	"QTD_SKU=SKUS",
	"VLR_VENDA_TOTAL=VENDA",
	"VLR_COMPRA_TOTAL=COMPRA",
	"VLR_ENTRADA_BONIFICADA=BONIF",
	"VLR_CUSTO_BRUTO_CD=CUSTO_CD",
	"VLR_CUSTO_BRUTO_LOJAS=CUSTO_LOJAS",
	"VLR_CUSTO_BRUTO_TOTAL_EMPRESA=TOTAL_EMPRESA",
	"QTD_INCINERACAO_ANO_ATUAL=INCINER",
]
