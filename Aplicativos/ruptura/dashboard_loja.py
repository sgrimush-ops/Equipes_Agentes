...
def principal():
    ...
    avg_rup_loja = final_df[~mask_total].groupby('COMPRADOR_FILTER')['% Ruptura Loja'].mean()
    final_df.loc[mask_total, '% Ruptura Loja'] = final_df.loc[mask_total, 'COMPRADOR_FILTER'].map(avg_rup_loja)
