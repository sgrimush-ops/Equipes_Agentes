...
- **Regra de Ouro da Pirâmide de Afunilamento Inicial**: Sempre que houver códigos informados (fornecedores, produtos, departamentos, compradores), eles DEVEM ser filtrados na primeiríssima CTE materializada (`WITH ... AS (SELECT /*+ MATERIALIZE */ ...)`). Nunca faça varredura massiva em `MRL_CUSTODIA` ou tabelas fiscais abertas para o banco todo antes de afunilar os itens para o conjunto exato.
